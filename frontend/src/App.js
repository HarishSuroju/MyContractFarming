      ...
      <Router>
        <div className="App">
          ...
          <Routes>
            ...
            />
            <Route
              path="/agreement-manager/:agreementId"
              element={
                <ProtectedRoute>
                  <AgreementManager />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/agreement-report/:agreementId"
              element={
                <ProtectedRoute>
                  <AgreementReport />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/agreement-edit/:agreementId"
              element={
                <ProtectedRoute>
                  <AgreementEdit />
                </ProtectedRoute>
            ...
            {/* 📩 CONNECTIONS */}
            <Route
              path="/connection-request/:userId"
              element={
                <ProtectedRoute>
            ...
            {/* 🌾 FARMER / CONTRACTOR INTEREST */}
            <Route
              path="/farmer-interest/:userId"
              element={
                <ProtectedRoute>
                  <FarmerInterestRequest />
                </ProtectedRoute>
              }
            />
            <Route
