      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="mt-4 text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→ View Now</div>
          </div>
          <div
            className="bg-white shadow-lg rounded-xl p-8 hover:shadow-2xl hover:-translate-y-2 hover:scale-105 transition-all duration-300 cursor-pointer border border-gray-200 hover:border-blue-300 group"
          ...
          >
            ...
            <div className="mt-4 text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→ Edit Profile</div>
          </div>
        </section>
